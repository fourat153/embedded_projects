...
# 291 "./mcc_generated_files/memory.h"
...
# 1 "./../x1.X/module/RealTimeClock/RealTimeClock.h" 1
# 11 "./../x1.X/module/RealTimeClock/RealTimeClock.h"
# 1 "./../x1.X/module/RealTimeClock/../../mcc_generated_files/examples/i2c_master_example.h" 1
# 54 "./../x1.X/module/RealTimeClock/../../mcc_generated_files/examples/i2c_master_example.h"
...
# 11 "./../x1.X/module/RealTimeClock/RealTimeClock.h" 2

# 1 "./../x1.X/module/RealTimeClock/../../module/uartlogging/uartlogging.h" 1
# 12 "./../x1.X/module/RealTimeClock/../../module/uartlogging/uartlogging.h"
void uart_loggingDebugData(uint8_t * str , uint16_t str_length);
# 12 "./../x1.X/module/RealTimeClock/RealTimeClock.h" 2
...
# 1 "./module/EEPROM24/eeprom.h" 1
# 11 "./module/EEPROM24/eeprom.h"
...
RealaTimeClockDSI_t RealaTimeClockDSI_obj ;
uint8_t temp = 0 ;
void main(void)
{
...
# 77 "main.c"
   ...
   eeprom_24_writebyte(0xA2 ,0x08 , 5) ;
   eeprom_24_writebyte(0xA6 ,0x08 , 6) ;

    while (1)
    {
        RealaTimeClockDSI_obj = realtimeclockDSI();
        print_realtimeclock();
        temp = TempSensorRead(0x9E);
