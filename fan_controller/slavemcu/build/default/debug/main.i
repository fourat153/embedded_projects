...
# 1 "./../mini_project smart home .X/EEPROM/eeprom.h" 1
# 12 "./../mini_project smart home .X/EEPROM/eeprom.h"
...
# 1 "./../mini_project smart home .X/temp_sensor/temp_sensor.h" 1
# 14 "./../mini_project smart home .X/temp_sensor/temp_sensor.h"
...
# 76 "main.c"
    ...
    while (1)
    {
        ...
        temp_value = Sensor_ReadTemp(0x9E);
        if (temp_value > 35 )
        {
            I2C_Write1ByteRegister(0x70 , 0x00 , temp_value) ;
        }
    }
}
